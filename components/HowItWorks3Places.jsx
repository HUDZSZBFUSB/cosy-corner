...
const CARDS = [
  {
    img: "https://cdn.shopify.com/s/files/1/0996/5512/3321/files/hhh16.png?v=1777916052",
  ...
  {
    img: "https://cdn.shopify.com/s/files/1/0996/5512/3321/files/hhh15_1.jpg?v=1777916050",
    title: "Posez et laissez parler",
    desc: "Aucun montage. Positionnez le canapé, reculez, et laissez le design s'exprimer.",
  },
  {
    img: "https://cdn.shopify.com/s/files/1/0996/5512/3321/files/hhh14_2.png?v=1777916051",
    title: "Profitez",
    desc: "Coussins profonds, forme iconique, trois places de pur confort. Et oui, tout le monde vous demandera où vous l'avez trouvé.",
  },
];

export default function HowItWorks3Places() {
